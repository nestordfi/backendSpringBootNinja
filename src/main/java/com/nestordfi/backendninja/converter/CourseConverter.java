package com.nestordfi.backendninja.converter;
...
public class CourseConverter {
	...
	public List<CourseModel> entity2Model(List<Course> listCourse) {
		List<CourseModel> listReturn = new ArrayList<>();
